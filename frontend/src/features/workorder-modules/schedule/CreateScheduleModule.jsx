...
export function CreateScheduleModule({ access, activeSection, form, locale = "en", onChange }) {
  ...
  return (
    <ProgressiveWorkorderSection id="schedule" className="create-workorder-card" title={t("create.schedule.title")} summary={t("create.schedule.summary")} activeSection={activeSection} onSelect={() => {}} displayMode="panel" keepMounted>
