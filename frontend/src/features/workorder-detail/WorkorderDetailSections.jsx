...
export function WorkorderDetailSections({
  ...
  setDetailSection,
  setOfficeAssignment,
  updateActiveUsedParts, updateActiveLaborHours, updateField,
  updateOfficeMechanicTeam, updateStartDate, updateUnitNumber,
  onUnitNumberCommit, unitLookupQuery, unitHistoryController,
  ...
  const moduleProps = {
    ...
    concern: {
      ...
      missingInfoNote: missingInfoAttention?.details?.note || missingInfoAttention?.note || activeWorkorder.workorder.missingInfoNote || (isMechanicDetail ? t("detail.moreInfoRequested") : "Surveillance requested more information."),
      locale: isMechanicDetail ? locale : "en",
      isMechanicDetail,
    ...
    photos: { activeSection: detailSection, messages: conversationMessages, onSelect: setDetailSection, locale },
    schedule: {
      activeSection: detailSection,
      allowedActions: activeWorkorder.allowedActions,
